...
public:
    ...
    bool isEnPassantPossible(ChessSquare &initial, ChessSquare &dest, 
                             ChessColour turn, ChessMove &lastMove); // check whether the en passant move can be achieved
    ...
    void pawnPromotion(int row, int column, ChessColour colour, bool isHuman);           // promote pawn
